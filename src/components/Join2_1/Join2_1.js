        ...
        <form name="write_form_member" method="post">
          <table>
            ...
            <tr>
              ...
              {/* <!-- alert 창 띄우기 --> */}
              <button onClick={checkID} className={styles.checkbtn}>중복확인</button>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input type="password" name="" className={styles.input_box} placeholder=" 영문 대소문자/숫자 혼합 10~15자리 내로 입력해주세요." onBlur={checkPassword}  value={firstPassword} />
              </td>
            </tr>
            <tr>
              <th><span>*</span> 비밀번호 확인</th>
              <td><input type="password" className={styles.input_box} name="" value={lastPassword} />
              <button onClick={comparePassword} className={styles.checkbtn}>비밀번호 확인</button></td>
            </tr>
              <tr>
              <th><span>*</span> 휴대폰 번호</th>
                <td><input type="text" className={styles.phone_box} /> -
                    ...
                    <button onClick={sendMsg} className={styles.checkbtn}>인증번호발송</button>
                </td>
              </tr>
              <tr>
                ...
                <td>
                <input type="text" className={styles.input_box} name="" />
                <button onClick={checkMsg} className={styles.checkbtn}>확인</button>
                </td>
              </tr>
              <tr>
                ...
                <button onClick={checkEmail} className={styles.checkbtn}>인증</button>
                </td>
              </tr>
                </table>
            </form>            
